			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="${ctxPath }/admin/categorylist.jsp"><span class="glyphicon glyphicon-pushpin"></span>&nbsp;&nbsp;分类管理</a></li>
			 ...
			 <div class="row">
		        <div class="col-md-12">
		            ...
		            <div class="col-md-12 pad0">
		           		<!-- 添加分类 -->
		                <form action="${ctxPath }/CategoryServlet?opt=add&role=3" method="post">
		                    <div class="col-md-10">
		                        <input class="form-control" name="name" placeholder="请输入要添加的图书分类">
		                    </div>
		                    <div class="col-md-2">
		            ...
		            <div class="col-md-10 taglist">
		                <!-- 分类 -->
		                <c:forEach items="${clist}" var="c">
							<div class="alert alert-success alert-dismissible pull-left" role="alert">
			                    <button type="button" class="close" id="cid${c.id}" title="编辑" onclick="changeCate(this)"><span class="glyphicon glyphicon-edit" style="font-size:13px;"></span></button>
			                    <strong title="${c.id}">${c.name }</strong>
				...
				$(input).bind({ 
					blur:function(){ 
						...
						if(id!='' && id!=null && name!=null && name!='' && name!=$(strong).html()){
							...
							$.ajax({
								type:'get',
								url:'${ctxPath }/CategoryServlet?opt=edit&role=3',
								data:"cid="+id+"&name="+name,
