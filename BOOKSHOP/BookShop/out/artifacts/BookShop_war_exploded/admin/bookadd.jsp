		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
		               ...
		               <a href="${ctxPath }/BookServlet?opt=booklist&role=3" class="list-group-item">图书管理</a>
			            <a href="" class="list-group-item active">添加图书</a>
		            </div>
				</div>
				<!-- 子导航 -->
				<!-- 内容 -->
				<div class="col-md-10">
					...
					<ul class="nav nav-tabs">
				        <li class="active">
				            <a href="user_list.html">添加图书</a>
				        </li>
				    </ul>
				    
				    <div>
				    	<form action="${ctxPath }/BookServlet?opt=add&role=3" method="post">
		                    <div class="form-group">
		                        <label for="title">书名*</label>
		                        <input type="text" name="title" class="form-control" placeholder="书名">
		                    </div>
		                    <div class="form-group">
		                        <label for="unitPrice">单价(元)*</label>
		                        <input type="text" value="0.0" name="unitPrice" class="form-control" placeholder="单价">
		                    </div>
		                    <div class="form-group">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <input type="text" value="2016-01-01 00:00:00" name="publishDate" class="form-control" placeholder="出版时间">
		                    </div>
		                    <div class="form-group">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <input type="text" value="0" name="wordsCount" class="form-control" placeholder="字数">
		                    </div>
		                    <div class="form-group">
		                        <label for="ContentDescription">内容介绍</label>
		                        <textarea class="form-control" name="contentDescription" rows="6"></textarea>
		                    </div>
		                    <div class="form-group">
		                        <label for="AuthorDescription">作者介绍</label>
		                        <textarea class="form-control" name="authorDescription" rows="6"></textarea>
		                    </div>
